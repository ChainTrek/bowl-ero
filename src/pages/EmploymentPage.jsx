								...
								<form className='employment-form' onSubmit={handleSubmit}>
											...
											<>
												<div className='form-group'>
													<label htmlFor='organizations_memberships'>
														Professional, trade, business, or civic
														organizations
													</label>
													<textarea
												...
												<div className='form-group'>
													<label htmlFor='special_training'>
														Special courses, seminars, or training related to
														the position
													</label>
													<textarea
														id='special_training'
									...
									{statusMessage && (
										<p
											className={
												isSuccess
													? 'employment-form__success'
													: 'employment-form__error'
											}
										>
											{statusMessage}
										</p>
										...
										<div className='employment-form__review-links'>
											{EMPLOYMENT_STEPS.slice(0, -1).map((step, index) => (
												<button
													...
													className='secondary-button'
													onClick={() =>
														goToStep(index, { returnToReview: true })
													}
												>
													Edit {step.title}
												</button>
