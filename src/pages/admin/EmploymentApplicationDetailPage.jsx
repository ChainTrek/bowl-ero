...
export default function EmploymentApplicationDetailPage() {
	...
	async function handleMarkReviewed() {
		if (!application || application.reviewed) {
			return
		}
		...
		try {
			...
			const updatedApplication =
				await markEmploymentApplicationReviewed(id)
		...
		<section className='admin-page employment-application-detail-page'>
			<div className='admin-page__header employment-application-detail-page__header no-print'>
				<div>
					...
					<p>
						Review the submitted employment application in
						full.
					</p>
				</div>
			...
			{loading ? (
				...
				<>
					<div className='screen-only'>
						<div className='employment-application-detail'>
							<div className='admin-card employment-application-detail__hero application-print-header'>
								<p className='application-print-header__eyebrow'>
									Bowl-Ero Lanes
								</p>
							...
							<div className='admin-card'>
								...
								<div className='employment-detail-grid'>
									...
									<div>
										...
										<p>
											{displayValue(
												application.legally_eligible_to_work,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.has_food_handlers_card,
											)}
										</p>
									</div>
								</div>
							...
							<div className='admin-card'>
								...
								<div className='employment-detail-grid'>
									<div>
										...
										<p>
											{displayValue(
												application.can_perform_essential_functions,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Essential Functions Explanation
										</strong>
										<p>
											{displayValue(
												application.essential_functions_explanation,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.worked_here_before,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Relatives or Friends at Company
										</strong>
										<p>
											{displayValue(
												application.has_company_relatives_or_friends,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Relatives/Friends Details
										</strong>
										<p>
											{displayValue(
												application.company_relatives_or_friends_details,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.days_hours_available,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.presently_employed,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.reason_for_leaving_current_job,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											May Contact Current Employer
										</strong>
										<p>
											{displayValue(
												application.may_contact_current_employer,
											)}
										</p>
									</div>
								</div>
							...
							<div className='admin-card'>
								...
								<div className='employment-detail-grid'>
									<div>
										...
										<p>
											{displayValue(
												application.organizations_memberships,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.high_school_course_of_study,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.high_school_years_completed,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.high_school_diploma_or_degree,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.college_course_of_study,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.college_years_completed,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.college_diploma_or_degree,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Trade School Course of Study
										</strong>
										<p>
											{displayValue(
												application.trade_school_course_of_study,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Trade School Years Completed
										</strong>
										<p>
											{displayValue(
												application.trade_school_years_completed,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.trade_school_diploma_or_degree,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.graduate_work_name,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Graduate Work Course of Study
										</strong>
										<p>
											{displayValue(
												application.graduate_work_course_of_study,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Graduate Work Years Completed
										</strong>
										<p>
											{displayValue(
												application.graduate_work_years_completed,
											)}
										</p>
									</div>
									...
									<div>
										<strong>
											Graduate Work Diploma / Degree
										</strong>
										<p>
											{displayValue(
												application.graduate_work_diploma_or_degree,
											)}
										</p>
									</div>
								</div>
							...
							<div className='admin-card'>
								...
								<div className='employment-detail-grid'>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_1_address,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_1_supervisor,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_1_reason_for_leaving,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_1_work_performed,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_2_address,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_2_supervisor,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_2_reason_for_leaving,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.employer_2_work_performed,
											)}
										</p>
									</div>
								</div>
							...
							<div className='admin-card'>
								...
								<div className='employment-detail-grid'>
									...
									<div>
										...
										<p>
											{displayValue(
												application.reference_1_address,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayValue(
												application.reference_2_address,
											)}
										</p>
									</div>
									...
									<div>
										...
										<p>
											{displayBoolean(
												application.applicant_acknowledgement,
											)}
										</p>
									</div>
								</div>
					...
					<div className='print-only'>
						<EmploymentApplicationPrintTemplate
