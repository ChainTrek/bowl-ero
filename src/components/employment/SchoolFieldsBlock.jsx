...
export default function SchoolFieldsBlock({ title, prefix, formData, onChange }) {
	return (
		<EmploymentCardSection title={title}>
			<div className='employment-form__grid'>
				<div className='form-group'>
					<label htmlFor={`${prefix}_name`}>Name and Location of School</label>
					<input
						id={`${prefix}_name`}
						name={`${prefix}_name`}
						type='text'
			...
			<div className='employment-form__grid'>
				...
				<div className='form-group'>
					<label htmlFor={`${prefix}_diploma_or_degree`}>Diploma or Degree</label>
					<input
