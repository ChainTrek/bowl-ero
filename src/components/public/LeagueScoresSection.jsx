...
export default function LeagueScoresSection() {
	...
	return (
		<section className='league-scores-section public-section'>
			<div className='league-scores-section__inner public-container'>
				<div className='public-section-header'>
					<span className='public-eyebrow'>Competition</span>
					<h2 className='public-heading'>League Scores</h2>
					<p className='public-subheading'>
						Follow the latest posted weekly scores from Bowl-Ero’s active leagues.
					</p>
				</div>
